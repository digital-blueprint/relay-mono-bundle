...
* Rename `src/DbpRelayMonoBundle` and `DependencyInjection/DbpRelayMonoExtension` to match the new project name
...
The value gets read in `DbpRelayMonoExtension` (your extension will be named differently)
