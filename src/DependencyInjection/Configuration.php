            ...
            ->getRootNode()
                ->children()
                    ...
                    ->arrayNode('payment_types')
                        ...
                        ->end()
                    ->end()
                    ->arrayNode('payment_profiles')
                        ->info('A list of payment profiles. A payment profiles is a combination of a payment client configuration and a payment service provider configuration.')
                        ->defaultValue([])
                        ->arrayPrototype()
                            ->children()
                                ->scalarNode('type')
