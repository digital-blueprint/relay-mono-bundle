                        ...
                        ->arrayPrototype()
                            ->children()
                                ...
                                ->scalarNode('session_timeout')
                                    ->info('Time after which a payment session can no longer be continued. In ISO duration format.')
                                ...
                                ->arrayNode('notify_error')
                                    ->info('Configuration for reports about completed payments that have not been notified')
                                    ->children()
                                        ->scalarNode('dsn')
                                        ...
                                        ->scalarNode('subject')
                                            ...
                                            ->isRequired()
                                        ->end()
                                        ->scalarNode('report_after')
                                            ->info('How long a completed payment may remain unnotified before it is included in the report (e.g., PT1H for 1 hour)')
                                            ->defaultValue('PT1H')
                                        ->end()
                                        ->enumNode('cadence')
                                            ->info('How often the notification error report is sent.')
                                ...
                                ->end()
                                ->arrayNode('reporting')
                                    ->info('Configuration for recurring email reporting about payment activity and outcomes.')
                                    ->children()
                                        ->scalarNode('dsn')
                                            ->info('The mailer transport DSN to use for sending the email')
                                            ->isRequired()
                                        ...
                                        ->end()
                                        ->enumNode('cadence')
                                            ->info('How often the report is sent and which completed UTC period it covers.')
                                            ->values(['hourly', 'daily', 'weekly'])
                                            ->defaultValue('weekly')
                                        ->end()
                                    ->end()
                                ...
                                ->arrayPrototype()
                                    ->children()
                                        ->enumNode('payment_status')
                                            ->values(['prepared', 'pending', 'failed', 'completed'])
                                            ->isRequired()
                                        ->end()
